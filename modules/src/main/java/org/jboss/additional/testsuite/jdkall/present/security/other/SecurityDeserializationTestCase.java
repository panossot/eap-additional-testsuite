...
public class SecurityDeserializationTestCase {
    ...
    @ATTest({"modules/testcases/jdkAll/Wildfly/security/src/main/java#18.0.0.Beta1","modules/testcases/jdkAll/Eap72x-Proposed/security/src/main/java#7.2.4","modules/testcases/jdkAll/Eap72x/security/src/main/java#7.2.4"})
    public void testSecuirtyDatabind12() throws Exception {

        final String JSON = aposToQuotes(
                "{'v':['org.jdom.transform.XSLTransformerTest']}"
                 );
